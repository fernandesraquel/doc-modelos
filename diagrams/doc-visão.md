...
## 6.Lista de Requisitos Funcionais
...
|RF008 - Emissão de Nota Fiscal|	O sistema deve ser capaz de gerar notas fiscais automaticamente para as vendas realizadas. As notas fiscais devem incluir informações como os produtos vendidos, valor total da venda, dados do cliente e informações fiscais adequadas.|	Gerente e Vendedor|
|RF009 - Geração de Relatórios|	O sistema deve ser capaz de gerar  relatórios de vendas diárias, vendas por período, desempenho dos vendedores e estoque atual.|	Gerente e Vendedor|
|RF010 - Busca de Informações|	O sistema deve permitir a busca de informações sobre vendedores, fornecedores, clientes, produtos e estoque com base em critérios específicos, como nome, código, ou outras informações relevantes.|	Gerente e Vendedor|
|RF011 - Exclusão de Registros|	O sistema deve permitir a exclusão de registros de vendedores, fornecedores, clientes e produtos caso necessário.|	Gerente |
...
## 7. Lista de Requisitos Não-Funcionais
|Requisito|	Descrição|
|---|---|
